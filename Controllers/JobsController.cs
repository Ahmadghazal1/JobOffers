...
namespace JobsOffers.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        {
            var jobs = db.Jobs.Include(j => j.Catrgory);
        ...
        {
            ViewBag.CategoryId = new SelectList(db.Catrgories, "Id", "CatrgoryName");
            return View();
        }
        ...
        public ActionResult Create( Job job , HttpPostedFileBase upload)
        {
            ...
            ViewBag.CategoryId = new SelectList(db.Catrgories, "Id", "CatrgoryName", job.CategoryId);
            return View(job);
        }
